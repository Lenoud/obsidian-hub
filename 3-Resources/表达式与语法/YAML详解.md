...
## 相关资料
+ **YAML 官方网站**[https://yaml.org](https://link.zhihu.com/?target=https%3A//yaml.org)

+ **YAML 1.2 官方文档**[https://yaml.org/spec/1.2/spec.html](https://link.zhihu.com/?target=https%3A//yaml.org/spec/1.2/spec.html)

+ **YAML - 维基百科**[https://zh.wikipedia.org/wiki/YAML](https://link.zhihu.com/?target=https%3A//zh.wikipedia.org/wiki/YAML)

+ **YAML to JSON （格式在线转换）**[https://www.json2yaml.com/convert-yaml-to-json](https://link.zhihu.com/?target=https%3A//www.json2yaml.com/convert-yaml-to-json)
